...
class rx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.active_subcarriers = active_subcarriers = (list(range(-26, 0)) + list(range(1, 27)) ,)
        ...
        self.payload_equalizer = payload_equalizer = digital.ofdm_equalizer_static(fft_len,  active_subcarriers, pilot_carriers_0, pilot_symbols_0,0,True)
        ...
        self.tab_const_layout_0 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_const_widget_0)
        self.tab_const_grid_layout_0 = Qt.QGridLayout()
        self.tab_const_layout_0.addLayout(self.tab_const_grid_layout_0)
        self.tab_const.addTab(self.tab_const_widget_0, 'Pre-Equalization (Single-Subcarrier)')
        self.tab_const_widget_1 = Qt.QWidget()
        self.tab_const_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_const_widget_1)
        self.tab_const_grid_layout_1 = Qt.QGridLayout()
        self.tab_const_layout_1.addLayout(self.tab_const_grid_layout_1)
        self.tab_const.addTab(self.tab_const_widget_1, 'Pre-Equalization (All Subcarriers)')
        self.tab_const_widget_2 = Qt.QWidget()
        self.tab_const_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_const_widget_2)
        self.tab_const_grid_layout_2 = Qt.QGridLayout()
        self.tab_const_layout_2.addLayout(self.tab_const_grid_layout_2)
        self.tab_const.addTab(self.tab_const_widget_2, 'Post-Equalization (All Subcarriers)')
        ...
        self._sc_select_win = RangeWidget(self._sc_select_range, self.set_sc_select, 'Sub Carrier Select', "counter_slider", float)
        ...
        self._mp_gain_win = RangeWidget(self._mp_gain_range, self.set_mp_gain, 'Multipath Gain', "counter_slider", float)
        ...
        self._mp_delay_win = RangeWidget(self._mp_delay_range, self.set_mp_delay, 'Multipath Delay (Samples)', "counter_slider", float)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 2, 4, 8, 4)
        for r in range(2, 10):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_vector_to_stream_0_0_1_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 64)
        self.blocks_vector_to_stream_0_0_1 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 64)
        ...
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, fft_len)
        ...
        self.connect((self.blocks_stream_to_vector_1, 0), (self.digital_ofdm_serializer_vcc_payload, 0))
        ...
        self.connect((self.digital_header_payload_demux_0, 1), (self.blocks_vector_to_stream_0_0, 0))
        self.connect((self.digital_header_payload_demux_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.digital_ofdm_chanest_vcvc_0, 0), (self.digital_ofdm_frame_equalizer_vcvc_0, 0))
        self.connect((self.digital_ofdm_frame_equalizer_vcvc_0, 0), (self.digital_ofdm_serializer_vcc_header, 0))
        self.connect((self.digital_ofdm_frame_equalizer_vcvc_1, 0), (self.blocks_vector_to_stream_0_0_1_0, 0))
        ...
        self.connect((self.fft_vxx_1, 0), (self.blocks_vector_to_stream_0_0_1, 0))
    ...
    def set_pilot_symbols_0(self, pilot_symbols_0):
        ...
        self.set_payload_equalizer(digital.ofdm_equalizer_static(self.fft_len,  self.active_subcarriers, self.pilot_carriers_0, self.pilot_symbols_0,0,True))
    ...
    def get_sc_select(self):
        return self.sc_select

    def set_sc_select(self, sc_select):
        self.sc_select = sc_select
        self.blocks_keep_m_in_n_0.set_offset(self.sc_select)
    ...
    def get_mp_gain(self):
        return self.mp_gain

    def set_mp_gain(self, mp_gain):
        self.mp_gain = mp_gain
        self.blocks_multiply_const_vxx_1.set_k(self.mp_gain)

    def get_mp_delay(self):
        return self.mp_delay

    def set_mp_delay(self, mp_delay):
        self.mp_delay = mp_delay
        self.blocks_delay_2.set_dly(self.mp_delay)
    ...
    def set_cp_delay(self, cp_delay):
